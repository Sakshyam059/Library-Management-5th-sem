<section class="fixed hidden  z-30 " id="delete_message">
    <div class="fixed inset-0 bg-black bg-opacity-60">
    </div>
    <div class=" fixed inset-32 w-2/5 h-fit  mx-auto bg-white rounded-md p-4 z-40 shadow-sm  shadow-black/40 ">
        <svg class="svg-icon w-24  m-6 bg-stone-100 p-4 mx-auto rounded-full border-2 border-gray-800"
            viewBox="0 0 20 20">
            <path
        ...
        <div class="flex items-center justify-center gap-4">
            <input type="button" class="bg-stone-600 text-white px-14 py-2 my-4 rounded-md shadow-sm shadow-gray-600/40" value="Cancel"
                id="cancel">
                @yield('deleteroute')
