...
@section('main')
<section class="relative mt-14 lg:mt-20  mx-auto max-w-screen-xl">
<div class="flex flex-col lg:flex-row my-2 lg:h-80 rounded-md overflow-hidden">
            <div class="flex-1 lg:text-lg bg-stone-200 p-10 ">
                <header class="font-bold text-5xl pb-4">About US</header>
                A project on <span class="text-amber-500"> Lumbini</span> <span class="text-blue-600"> Elibrary</span> offers you the best library management system.
                <small>Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi assumenda voluptatem neque voluptas deleniti. Vel ratione tenetur accusantium atque quae expedita eligendi voluptate nobis quasi, sapiente quam porro hic aspernatur?</small>
            </div>
            <div class="flex-1 font-thin text-justify">
                <img src="{{asset('images/components/cover2.jpg')}}" alt="" class="w-full lg:h-80">
            </div>
        </div>
        <div class="mb-12">
    </div>
    ...
    <div class="mx-auto p-3 lg:p-10">
        ...
        <div class="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-2 ">
          <div class="mx-auto w-11/12 lg:w-[300px] rounded-md border">
            <img
              src="https://c4.wallpaperflare.com/wallpaper/836/731/688/batman-logo-batman-minimalism-portrait-display-wallpaper-preview.jpg"
              alt="profile"
              class="h-[200px] w-full rounded-t-md object-cover"
            />
            <div class="p-4">
              <h1 class="text-lg font-semibold">Sakshyam Gurau</h1>
              <h6 class="mt-3 font-medium">Web Developer</h6>
          ...
          <div class="mx-auto w-11/12 lg:w-[300px] rounded-md border">
            <img
              src="https://www.redwolf.in/image/cache/catalog/artwork-Images/mens/superman-the-man-of-steel-logo-t-shirt-artwork-500x667.png?m=1687857212"
              alt="Profile"
              class="h-[200px] w-full rounded-t-md object-cover"
            />
            <div class="p-4">
              <h1 class="text-lg font-semibold">Amod KC</h1>
              <h6 class="mt-3 font-medium">Web Developer</h6>
              <p class="mt-3 text-sm text-gray-600">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi,
                debitis?
            ...
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-stone-900 ">Contact Us</h2>
                <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Got a technical issue? Want to send feedback about a beta feature? Need details about our Business plan? Let us know.</p>
                <form action="#" class="space-y-8">
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-stone-600">Your email</label>
                        <input type="email" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-stone-200 dark:border-gray-600 dark:placeholder-gray-400 dark:text-stone-800 dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="name@flowbite.com" required>
                    </div>
                    <div>
                        <label for="subject" class="block mb-2 text-sm font-medium text-gray-900 dark:text-stone-600">Subject</label>
                        <input type="text" id="subject" class="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-stone-200 dark:border-gray-600 dark:placeholder-gray-400 dark:text-stone-800 dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Let us know how we can help you" required>
                    </div>
                    <div class="sm:col-span-2">
                        <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-stone-600">Your message</label>
                        <textarea id="message" rows="6" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-stone-200 dark:border-gray-600 dark:placeholder-gray-400 dark:text-stone-800 dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Leave a comment..."></textarea>
                    </div>
                    <button type="submit" class="py-3 px-5 text-sm bg-blue-900 font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
                </form>
            </div>
