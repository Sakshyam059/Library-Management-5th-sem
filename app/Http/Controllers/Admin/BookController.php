...
class BookController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $all_books= Book::all();
        return view('admin.book.edit',compact('update_book','all_books'));
    }
    ...
    public function update(Request $request, Book $id)
    {
        ...
        return redirect(route('admin.book.index'))->with('success','Image Updated Succesfully');
    }
